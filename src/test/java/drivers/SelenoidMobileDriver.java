...
//            return new URL("https://user1:1234@selenoid.autotests.cloud:4444/wd/hub");
    ...
    private URL apkUrl() {
        try {
//            return new File("./src/test/resources/apps/app-alpha-universal-release.apk").toURI().toURL(); // todo
            return new URL("https://github.com/wikimedia/apps-android-wikipedia/releases/" +
                            "download/untagged-4569c2d6deed0da37be2/app-alpha-universal-release.apk");
        } catch (MalformedURLException e) {
            e.printStackTrace();
        }
        return null;
